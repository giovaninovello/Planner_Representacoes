			...
			<div class="hero_section">
				<div class="row">
					...
					<div class="col-lg-7 col-sm-5">
						<img src="<?php echo base_url('assets/img/main_device_image.png"')?> class="zoomIn wow animated" alt="" />
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					...
					<div class=" col-lg-7 col-md-7 col-sm-7 col-xs-12 pull-left">
						<div class=" delay-01s animated fadeInDown wow animated">
							...
							<p>Fundada em 2006 a Planner Representações Comerciais, iniciou suas atividades atendendo ao mercado de Analises clinicas, intermediando contratos de prestações de serviços para a realização de exames Clínicos  de alta complexidade,  tendo como representada grande empresa de Analises Clinicas por 11anos.</p> <br>
							<p>Seu Sócio proprietário  atuou no mercado farmacêutico e cosméticos por 12 anos,  adquirindo larga experiência na divulgação e venda nos canais Pharma, hospitalares e distribuidores, ocupando cargo executivo de vendas em empresa Farmacêutica Multinacional por 12 anos, o que  credencia para desenvolver a atividade de representação comercial nestes Canais.</p>

							.</p>Hoje, a Planner, sediada em Florianópolis, através de novas parcerias expandiu suas atividades e atende o mercado de  eletrônicos, dispomos  de  equipe de vendas atendendo  em todo o Estado de Santa Catarina e Rio Grande do Sul. <br/>
							<p></p>
						</div>
			...
			<div class="row">
				<div class="col-lg-3">
					<div class="service_block">
						...
						<h3 class="animated fadeInUp wow">Laboratorios e Análises clínicas</h3>
						<p class="animated fadeInDown wow">Representação junto a rede de laboratórios de Analises.</p>
					</div>
				</div>
				<div class="col-lg-3 borderLeft">
					<div class="service_block">
						...
						<p class="animated fadeInDown wow">Representação junto a Farmácias e hospitais e  Distribuidores.</p>
					</div>
				</div>
				<div class="col-lg-3 borderLeft">
					<div class="service_block">
						...
						<p class="animated fadeInDown wow">Representação comercial de produtos eletrônicos.</p>
					</div>
				</div>
				<div class="col-lg-3 borderLeft">
					<div class="service_block">
						<div class="service_icon icon3  delay-03s animated wow zoomIn"> <span><i class="fa fa-recycle"></i></span> </div>
						<h3 class="animated fadeInUp wow">Produtos de Limpeza</h3>
						<p class="animated fadeInDown wow">Distribuidor Independente de produtos de limpeza sustentável.</p>
					</div>
				</div>
			</div>
